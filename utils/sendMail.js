...
exports.sendVerificationMail = async (code, email, name) => {
...
exports.sendPaymentStatus = async (email, name, status, addComments) => {
  const html = `
  <!doctype html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
...
<tr>
<td width="600">
<table cellpadding="0" cellspacing="0" bgcolor="#ffffff" height="44" width="100%" style="line-height:44px;height:44px!important;background-color:#ffffff;  border-collapse:separate !important;margin:0 auto;text-align:center;">
<tr>
<td> </td>
</tr>
</table>
...
<table cellspacing="0" cellpadding="0" border="0">
<tr>
<td width="202" align="center"><img src="https://plugin.markaimg.com/public/89a7a5b4/CtHpjivrVxgUHQkEr3pSYSnoLW1xoW.png" width="202" border="0" style="
         max-width:202px; width: 100%; height: auto; display: block;"></td>
</tr>
</table>
</td>
...
<tr>
<td align="center">
<div style="line-height:32px;text-align:center;"><span style="color:#363a57;font-weight:600;font-family:Roboto,Arial,sans-serif;font-size:24px;letter-spacing:-0.02em;line-height:32px;text-align:center;">Hi ${name}!!</span></div>
</td>
</tr>
</table>
</td>
...
<tr>
<td align="center">
<div style="line-height:24px;text-align:left;"><span style="color:#000000;font-family:Roboto,Arial,sans-serif;font-size:19px;line-height:24px;text-align:left;">Your Payment Status is: ${status}<br><br>${addComments}</span></div>
</td>
</tr>
<tr>
<td height="24" style="height:24px; min-height:24px; line-height:24px;"></td>
...
<tr>
<td align="center">
<div style="line-height:24px;text-align:left;"><span style="color:#000000;font-family:Roboto,Arial,sans-serif;font-size:19px;line-height:24px;text-align:left;">If you believe you need any more assistance, please reach out to our support team at </span><a href="mailto:tarang@iiitdmj.ac.in"><span style="color:#000000;font-family:Roboto,Arial,sans-serif;font-size:19px;text-decoration:underline;line-height:24px;text-align:left;">tarang@iiitdmj.ac.in</span></a><span style="color:#000000;font-family:Roboto,Arial,sans-serif;font-size:19px;line-height:24px;text-align:left;"> . We're here to help resolve any payment issues promptly.<br><br>If you didn't request this, ignore the email.<br><br>Best regards, <br>The Tarang Team</span></div>
</td>
</tr>
<tr>
<td height="24" style="height:24px; min-height:24px; line-height:24px;"></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="vertical-align: middle;" width="24"><img src="https://plugin.markaimg.com/public/89a7a5b4/Dk7ZPEuXjMsbfXRzdob4w4XkmJMoGr.png" width="24" border="0" style="min-width:24px; width:24px;
         min-width:24px; width:24px; height: auto; display: block;"></td>
<td style="width:16px; min-width:16px;" width="16"></td>
<td style="vertical-align: middle;" width="32"><img src="https://plugin.markaimg.com/public/89a7a5b4/hmFLzEVv2SIvxRq3aTLL5jnggiSduE.png" width="32" border="0" style="min-width:32px; width:32px;
...
<td height="24" style="height:24px; min-height:24px; line-height:24px;"></td>
  ...
  client
    .sendMail({
      ...
      subject: "Payment Verification Status for Tarang 2k23",
      htmlbody: html,
    })
    .then((resp) => null)
    .catch((error) => console.log(JSON.stringify(error)));
